...
const SSID: &str = "Xiaomi_E238";
#[allow(dead_code)]
#[cfg(not(feature = "qemu"))]
// const PASS: &str = env!("RUST_ESP32_STD_DEMO_WIFI_PASS");
const PASS: &str = "19871017";

#[allow(dead_code)]
#[cfg(not(feature = "qemu"))]
const AP_SSID: &str = "Mindot";
#[allow(dead_code)]
#[cfg(not(feature = "qemu"))]
const AP_PASS: &str = "111111";
...
// ) -> Result<Box<EspWifi>> {
//     let mut ap = Box::new(EspWifi::new(netif_stack, sys_loop_stack, default_nvs)?);

//     info!("Wifi AP created, about to connect");
